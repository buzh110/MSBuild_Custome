...
namespace MSBuild_Custome
    {
        ...
        public static void CopyDirectory(string sourceDirName, string destDirName,string filter)
            {
            try
                {
 ...
 RegexOptions.IgnoreCase);
               ...
               var files = Directory.GetFiles(sourceDirName).Where(s=>!searchPattern.IsMatch(s));
                ...
                foreach (string dir in dirs)
                    {
                    CopyDirectory(dir, destDirName + Path.GetFileName(dir),filter);
                    }
                }
            catch (Exception ex)
                {
        ...
        public static void Move(string sourceFilePath, string descDirectoryPath)
            ...
            public static void ErrorLog(string exMessage, string exMethod, int userID)
                ...
                try
                    ...
                    string errPath = Environment.CurrentDirectory+errVir;
            ...
            public static void OutDebugLog(object factValue, object expectValue = null)
                {
                string errPath =Environment.CurrentDirectory+string.Format("/Log/Debug/{0}.html", DateTime.Now.ToShortDateString());
